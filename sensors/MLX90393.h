#ifndef MBED_MLX9039xINT_H
#define MBED_MLX9039xINT_H
 
#include "mbed.h"
/** MLX90393 class.
 *  Used for communication with the MLX90393 in both I2C and SPI.
 *  AKN/JVV rev.2 INTERNAL USE (DT) - FEB2015
 */
class MLX90393
{
...
public:
    ...
    */
    ...
    /** Change the I2C Address of the object.
    * @param Address New I2C address.
    * @note Nothing returned.
    */
    void ChangeI2CAddress(int Address);
    ...
    */
    ...
    /** Send 'DT' command to MLX90393.
    * @param *receiveBuffer Pointer to receiveBuffer, will contain response of IC after command is sent.
    * @param mode Communication mode (0=I2C, 1=SPI).
    * @note The receiveBuffer will contain the status byte only.
    */
    void DT(char *receiveBuffer, int data, int mode);
